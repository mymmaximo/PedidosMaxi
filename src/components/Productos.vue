...
<script setup>
    ...
    import { CarritoLocal, CerrarSesion, Rol, ActualizarCajaP, ProductoActual, ProductoCantidad, PedidoActual, ClienteID, urlover8000, CargarCarrito, Iniciado, SesionExpirada } from './Estatus.js'
    // ----- Variables Vue ----- //
