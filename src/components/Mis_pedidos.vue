<template>
    ...
    <div class="contenedor_principal">
        ...
        <div class="contenedor_tabla" v-if="Pedidos.length > 0 && i.estatus === 3">
        <table class="tabla">
            <thead>
            <tr>
                <th>
        ...
        <div class="contenedor_tabla" v-if="Pedidos.length > 0 && i.estatus === 2">
        <table class="tabla">
            <thead>
            <tr>
                <th>
        ...
        <div class="contenedor_tabla" v-if="Pedidos.length > 0 && i.estatus === 1">
        <table class="tabla">
            <thead>
            <tr>
                <th>
